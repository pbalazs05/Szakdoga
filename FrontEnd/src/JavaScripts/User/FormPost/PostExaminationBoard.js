                ...
                <table className="GeneratedTable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input className="tdInput" type="text" name="presidentPositin" value={this.presidentPositin} onChange={e => this.setState({ presidentPositin: e.target.value })} required ></input></td>
                        ...
                        <tr>
                            ...
                            <td><input className="tdInput" type="text" name="substituteOnePosition" value={this.substituteOnePosition} onChange={e => this.setState({ substituteOnePosition: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="substituteOneRank" value={this.substituteOneRank} onChange={e => this.setState({ substituteOneRank: e.target.value })} required ></input></td>
                        ...
                        <tr>
                            ...
                            <td><input className="tdInput" type="text" name="substituteTwoPosition" value={this.substituteTwoPosition} onChange={e => this.setState({ substituteTwoPosition: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="substituteTwoRank" value={this.substituteTwoRank} onChange={e => this.setState({ substituteTwoRank: e.target.value })} required ></input></td>
                        ...
                        <tr>
                            ...
                            <td className="BoldFontStyle" >K</td>
                            <td><input className="tdInput" type="text" name="expertOneName" value={this.expertOneName} onChange={e => this.setState({ expertOneName: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertOnePosition" value={this.expertOnePosition} onChange={e => this.setState({ expertOnePosition: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertOneRank" value={this.expertOneRank} onChange={e => this.setState({ expertOneRank: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertOneInstitution" value={this.expertOneInstitution} onChange={e => this.setState({ expertOneInstitution: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertOneDepartment" value={this.expertOneDepartment} onChange={e => this.setState({ expertOneDepartment: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertOnePostCode" value={this.expertOnePostCode} onChange={e => this.setState({ expertOnePostCode: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertOneLocation" value={this.expertOneLocation} onChange={e => this.setState({ expertOneLocation: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertOneStreet" value={this.expertOneStreet} onChange={e => this.setState({ expertOneStreet: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertOneEmail" value={this.expertOneEmail} onChange={e => this.setState({ expertOneEmail: e.target.value })} required ></input></td>
                        </tr>
                        <tr>
                            <td className="BoldFontStyle" >Expert</td>
                            <td className="BoldFontStyle" >B</td>
                            <td><input className="tdInput" type="text" name="expertTwoName" value={this.expertTwoName} onChange={e => this.setState({ expertTwoName: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertTwoPosition" value={this.expertTwoPosition} onChange={e => this.setState({ expertTwoPosition: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertTwoRank" value={this.expertTwoRank} onChange={e => this.setState({ expertTwoRank: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertTwoInstitution" value={this.expertTwoInstitution} onChange={e => this.setState({ expertTwoInstitution: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertTwoDepartment" value={this.expertTwoDepartment} onChange={e => this.setState({ expertTwoDepartment: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertTwoPostCode" value={this.expertTwoPostCode} onChange={e => this.setState({ expertTwoPostCode: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertTwoLocation" value={this.expertTwoLocation} onChange={e => this.setState({ expertTwoLocation: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertTwoStreet" value={this.expertTwoStreet} onChange={e => this.setState({ expertTwoStreet: e.target.value })} required ></input></td>
                            <td><input className="tdInput" type="text" name="expertTwoEmail" value={this.expertTwoEmail} onChange={e => this.setState({ expertTwoEmail: e.target.value })} required ></input></td>
                        </tr>
                    </tbody>
                </table>
            </div>
